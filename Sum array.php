...
echo "Сложение массива из 10 элементов c помощью пользовательской функции for, выполненная 10000 раз занимает $time1 секунд.\n";
echo "<br>";
...
echo "Сложение массива из 10 элементов c помощью пользовательской функции foreach, выполненная 10000 раз занимает $time1 секунд.\n";
echo "<br>";
